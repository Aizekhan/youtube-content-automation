...
def merge_for_theme_agent(base, channel, template):
    ...
    return {
        **base,
        ...
        # Channel philosophy and variation strategy
        'core_idea': channel.get('core_idea'),
        'unique_variation_logic': channel.get('unique_variation_logic'),
...
def map_voice_profile_to_actual_voice(voice_profile, tts_service):
    ...
    voice_mapping = {
        # ============================================
        # AWS Neural Voices - Complete List (2024)
        # ============================================
        ...
        'kimberly_female': {
            'aws_polly_neural': 'Kimberly',
            'aws_polly_standard': 'Kimberly',
            'elevenlabs': 'Elli',
            'google_tts': 'en-US-Neural2-C'
        },
        'kendra_female': {
        ...
        'ivy_female': {
            'aws_polly_neural': 'Ivy',
            'aws_polly_standard': 'Ivy',
            'elevenlabs': 'Bella',
            'google_tts': 'en-US-Neural2-C'
        },
        'ruth_female': {
            'aws_polly_neural': 'Ruth',
            'aws_polly_standard': 'Joanna',  # Ruth is Neural-only
            'elevenlabs': 'Elli',
            'google_tts': 'en-US-Neural2-C'
        },
        'danielle_female': {
            'aws_polly_neural': 'Danielle',
            'aws_polly_standard': 'Joanna',  # Danielle is Neural-only
            'elevenlabs': 'Rachel',
            'google_tts': 'en-US-Neural2-E'
        },
        ...
        'gregory_male': {
            'aws_polly_neural': 'Gregory',
            'aws_polly_standard': 'Brian',  # Gregory is Neural-only, fallback to Brian
            'elevenlabs': 'Josh',
            'google_tts': 'en-GB-Neural2-B'
        },
        'kevin_male': {
            'aws_polly_neural': 'Kevin',
            'aws_polly_standard': 'Joey',  # Kevin is Neural-only
            'elevenlabs': 'Antoni',
            'google_tts': 'en-US-Neural2-A'
        },
        'stephen_male': {
            'aws_polly_neural': 'Stephen',
            'aws_polly_standard': 'Matthew',  # Stephen is Neural-only
            'elevenlabs': 'Josh',
            'google_tts': 'en-US-Neural2-D'
        },

        # ============================================
        # Legacy voice profiles (backward compatibility)
        # ============================================
        'deep_male': {
            'aws_polly_neural': 'Matthew',
            'aws_polly_standard': 'Matthew',
